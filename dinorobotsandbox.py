...
class Battlefield:
    ...
    def dino_turn(self):
        ...
        while True:   
            ...
            elif  'low' in self.herd.dinosaurs[0].name and user_choice2 == 0:
                print ('That dinosaur is low on energy! please select again \n')
                continue
                
            elif 'dead' in self.herd.dinosaurs[1].name and user_choice2 == 1:
                print ('That dinosaur is dead! please select again \n')
                continue
            ...
            elif 'dead' in self.herd.dinosaurs[2].name and user_choice2 == 2:
                print ('That dinosaur is dead! please select again \n')
                continue
        ...
        while True:
            ...
            if   'off' in self.fleet.robots[0].name and user_choice_attack == 0:
                    print('That Robot is powered off! Have mercy! Please select again')
                    continue  

            elif 'off' in self.fleet.robots[1].name and user_choice_attack == 1:
                    print('That Robot is powered off! Have mercy! Please select again')
                    continue

            elif 'off' in self.fleet.robots[2].name and user_choice_attack == 2:
                    print('That Robot is powered off! Have mercy! Please select again')
                    continue
        ...
        while True:
            ...
            if move_sel == 0:
                ...
                break
            elif move_sel  > 2 or user_choice2 < 0:
                print ('Sorry, only numbers 0 - 2 please')
                continue

        self.herd.dinosaurs[user_choice2].attack(self.fleet.robots[user_choice_attack])
        print (f'{self.herd.dinosaurs[user_choice2].name} attacks {self.fleet.robots[user_choice_attack].name} with the {self.herd.dinosaurs[user_choice2].move} and deals {self.herd.dinosaurs[user_choice2].attack_power} worth of damage! \n')
...
#this needs to be at the end so the main game over loop can do an accurate check before the next round begins
    ...
    def robo_turn(self):
        ...
        while True:
            ...
            if 'off' in self.fleet.robots[0].name and user_choice2 == 0:
            ...
            elif 'off' in self.fleet.robots[1].name and user_choice2 == 1:
                  print ('That robot is powered off! please select again \n')
                  continue
            ...
            elif 'off' in self.fleet.robots[2].name and user_choice2 == 2:
                  print ('That robot is powered off! please select again \n')
                  continue
        ...
        while True:
            ...
            if 'dead' in self.herd.dinosaurs[0].name and rob_user_choice_attack == 0:
                print('Sorry, that dinosaur is dead! Do not beat a dead dinosaur! Please select again. \n')
                continue
            
            elif 'dead' in self.herd.dinosaurs[1].name and rob_user_choice_attack == 1:
                print ('That dinosaur is dead! Do not beat a dead dinosaur! Please select again. \n')
                continue
                 
            elif 'dead' in self.herd.dinosaurs[2].name and rob_user_choice_attack == 2:
                print('That dinosaur is dead! Do not beat a dead dinosaur! Please select again \n')
                continue
